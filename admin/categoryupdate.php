...
if(isset($_POST['catupdate'])) 
{
	...
	if($ret) 
	{
		echo "<script>window.alert('Category Updated!')</script>";
		echo "<script>window.location='categorylist.php'</script>";
	}
	else
	{
		echo "<p>Something wrong in category update " . mysqli_errno($connection) . "</p>";
	}
	...
	<div class="card-body">
		<form action="" method="post" class="form-horizontal">
			...
			<div class="form-group text-primary"> <lable class="control-lable col-md-2">Category:</lable>
				<div class="col-md-12">
					<input type="text" name="txtcatname" value="<?php echo $cname?>" class="form-control"  required />
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-10">
						...
						<button type="submit" class="btn btn-dark" name="catupdate">Update</button>
					</div>
				</div>
			</form>
